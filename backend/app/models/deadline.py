...
def _get_business_or_404(db: Session, owner_id: int) -> BusinessProfile:
    ...
    if not profile:
        raise HTTPException(
            ...
            detail={
                "code": "NOT_FOUND",
                "message": "No business profile found. Please complete your profile setup first.",
            },
        )
    return profile
...
def delete_deadline(
    ...
    if not dl.is_custom:
        raise HTTPException(
            ...
            detail={
                "code": "FORBIDDEN",
                "message": "System deadlines cannot be deleted. Only custom deadlines can be removed.",
            },
        )
